const projects = [
    ...
    },
    {
        id: 'kuoto',
        name: 'Kuoto',
        description: 'Kuoto is a website for generating random quotes from Public API. This website is made for completing the course in Dicoding Indonesia (Belajar Fundamental Front-End Web Development). Kuoto was made by using ES6, Web Component, and Build Tools as taught in the course.',
        url: '#'
    },
    {
        id: 'muvila',
        name: 'Muvila',
        description: 'Muvila is a simple app that provide information about movies. This app also has feature for randomize movie that could be a choice for you to watch, if you are confused about choosing. Muvila is built by using Flutter.',
        url: 'https://github.com/nafladiva/movielist-flutter'
    },
    {
        id: 'airbud',
        name: 'Airbud',
        description: 'Airbud is a website where we can see the level of quality of air in certain areas/city. This website is built by using Django.',
        url: 'https://github.com/nafladiva/Airbud'
    },
    {
        id: 'cocheck',
        name: 'Co-Check',
