        ...
        <div className="mt-5 mt-sm-1 mt-md-3 container">
            <div className="row d-flex align-items-center">
                ...
                <div className="p-4 p-md-0 col-12 col-md-3 col-lg-3">
                    ...
                    <a href="https://github.com/nafladiva"><FaGithub size={22} className="m-2" /></a>
                    <a href="https://www.linkedin.com/in/nafla-diva-syafia/"><FaLinkedin size={22} className="m-2" /></a>
                </div>
            </div>
        </div>
    )
